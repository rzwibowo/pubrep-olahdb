        ...
        <div class="container-fluid" data-layout="container">
            ...
            <div class="content">
                ...
                <?php
                    ...
                    echo form_open_multipart('master_level/level_edit',$attributes); 
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md">
                                <h5 class="mb-2 mb-md-0">Edit Level</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <?php echo "<input type='hidden' name='id_level' value='$level[id_level]'>"; ?>
                    <div class="card-body bg-light">
                        <div class="form-row">                            
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="nama_level">Nama Level</label>
                                    <input class="form-control" id="nama_level" name="nama_level" type="text"
                                        placeholder="Nama Level"
                                        value='<?php echo $level['nama_level']; ?>'>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="<?php echo base_url()."master_level/level"; ?>"
