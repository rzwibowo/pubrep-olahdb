...
<body>
                            ...
                            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                                ...
                                <div id="dashboard-actions">
                                    <a class="btn btn-falcon-default btn-sm"
                                        href='<?php echo base_url(); ?>master_level/level_tambah' type="button"><span
                            ...
                            <table class="table table-striped table-hover table-sm border-bottom"
                                ...
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th class="sort pr-1 align-middle">Level</th>
    ...
    function hapus(id) {
        var datahapus = "id_level=" + id;
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>master_level/level_hapus",
            data: datahapus,
            cache: false,
            success: function(data) {
                var urltarget = "<?php echo base_url();?>master_level/level";
    ...
    function cari_ajax() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('master_level/cari_ajax'); ?>",
            data: datasend,
            dataType: 'json',
            success: function(data) {
