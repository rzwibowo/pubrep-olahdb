...
<body>
                            ...
                            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                                ...
                                <div id="dashboard-actions">
                                    <a class="btn btn-falcon-default btn-sm"
                                        href='<?php echo base_url(); ?>master_alasan/alasan_tambah' type="button"><span
    ...
    function hapus(id) {
        var datahapus = "id_alasan=" + id;
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>master_alasan/alasan_hapus",
            data: datahapus,
            cache: false,
            success: function(data) {
                var urltarget = "<?php echo base_url();?>master_alasan/alasan";
    ...
    function cari_ajax() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('master_alasan/cari_ajax'); ?>",
            data: datasend,
            dataType: 'json',
            success: function(data) {
