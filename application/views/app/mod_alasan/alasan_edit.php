        ...
        <div class="container-fluid" data-layout="container">
            ...
            <div class="content">
                ...
                <?php
                    ...
                    echo form_open_multipart('master_alasan/alasan_edit',$attributes); 
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md">
                                <h5 class="mb-2 mb-md-0">Edit Alasan</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <?php echo "<input type='hidden' name='id_alasan' value='$alasan[id_alasan]'>"; ?>
                    <div class="card-body bg-light">
                        <div class="form-row">                            
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="nama_alasan">Nama Alasan</label>
                                    <input class="form-control" id="nama_alasan" name="nama_alasan" type="text"
                                        placeholder="Nama Alasan"
                                        value='<?php echo $alasan['nama_alasan']; ?>'>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="<?php echo base_url()."master_alasan/alasan"; ?>"
