...
<body>
                            ...
                            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                                ...
                                <div id="dashboard-actions">
                                    <a class="btn btn-falcon-default btn-sm"
                                        href='<?php echo base_url(); ?>master_lokasi/lokasi_tambah' type="button"><span
                                    ...
                                    <button class="btn btn-falcon-default btn-sm" type="button"><span
                                            class="fas fa-print" data-fa-transform="shrink-3 down-2"></span><span
                                            class="d-none d-sm-inline-block ml-1">Cetak</span></button>
                            ...
                            <table class="table table-striped table-hover table-sm border-bottom"
                                ...
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th class="sort pr-1 align-middle" style="width: 120px;">Perusahaan</th>
                                        <th class="sort pr-1 align-middle">Lokasi</th>
    ...
    function hapus(id){
      var datahapus =  "id_lokasi=" + id ;
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>master_lokasi/lokasi_hapus",
        data: datahapus,
        cache: false,
        success: function(data)
        {                   
          var urltarget = "<?php echo base_url();?>master_lokasi/lokasi";    
    ...
    function cari_ajax() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('master_lokasi/cari_ajax'); ?>",
            data: datasend,
            dataType: 'json',
            success: function(data) {
