...
<body>
            ...
            <div class="content">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="mb-0"> Data Propinsi</h5>
                    </div>
                            ...
                            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                                ...
                                <div id="dashboard-actions">
                                    <a class="btn btn-falcon-default btn-sm"
                                        href='<?php echo base_url(); ?>master_propinsi/propinsi_tambah' type="button"><span
    ...
    function hapus(id){
      var datahapus =  "id_propinsi=" + id ;
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>master_propinsi/propinsi_hapus",
        data: datahapus,
        cache: false,
        success: function(data)
        {                   
          var urltarget = "<?php echo base_url();?>master_propinsi/propinsi";    
    ...
    function cari_ajax() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('master_propinsi/cari_ajax'); ?>",
            data: datasend,
            dataType: 'json',
            success: function(data) {
