        ...
        <div class="container-fluid" data-layout="container">
            ...
            <div class="content">
                ...
                <?php
                    ...
                    echo form_open_multipart('master_propinsi/propinsi_edit',$attributes); 
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md">
                                <h5 class="mb-2 mb-md-0">Edit propinsi</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <?php echo "<input type='hidden' name='id_propinsi' value='$propinsi[id_propinsi]'>"; ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="nama_propinsi" name="nama_propinsi" type="text"
                                        placeholder="Nama propinsi"
                                        value='<?php echo $propinsi['nama_propinsi']; ?>'>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="<?php echo base_url()."master_propinsi/propinsi"; ?>"
