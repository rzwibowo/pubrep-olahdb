    ...
    <main class="main" id="top">
        <div class="container-fluid" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md">
                                <h5 class="mb-2 mb-md-0">Edit Operator</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                echo form_open("master_operator/operator_edit_simpan", $attributes);
                ?>
                <div class="row no-gutters">
                    <div class="col-lg-6 pr-lg-2">
                        <div class="card mb-3">
                            ...
                            <div class="card-body bg-light">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <input type="hidden" id="id_operator" name="id_operator" value="<?php echo $operator['id_operator'] ?>">
                                        <input type="hidden" id="username_operator_old" name="username_operator_old" value="<?php echo $operator['username_operator'] ?>">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="id_level" name="id_level">
                                                ...
                                                foreach ($level as $rows) {
                                                    ...
                                                    if ($operator['id_level'] == $rows['id_level']) echo "selected";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="username_operator" name="username_operator" type="text" placeholder="Username" value="<?php echo $operator['username_operator'] ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="username_operator">Password</label>
                                            <input class="form-control" id="password_operator" name="password_operator" type="password" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="username_operator">Nama</label>
                                            <input class="form-control" id="nama_operator" name="nama_operator" type="text" placeholder="Nama" value="<?php echo $operator['nama_operator'] ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="username_operator">Telp</label>
                                            <input class="form-control" id="telp_operator" name="telp_operator" type="text" placeholder="Telepon" value="<?php echo $operator['telp_operator'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="username_operator">Alamat</label>
                                            <input class="form-control" id="alamat_operator" name="alamat_operator" type="text" placeholder="Alamat" value="<?php echo $operator['alamat_operator'] ?>">
                                        </div>
                    ...
                    <div class="col-lg-6 pl-lg-2">
                        <div class="card mb-3" style="height:300px">
                            <div class="card-header" id="upload-foto">
                                <h5 class="mb-0">Foto Sekarang</h5>
                            </div>
                            <div class="card-body bg-light text-center">
                                <?php if (isset($operator['foto_operator']) && $operator['foto_operator'] != 'no_gambar.jpg') { ?>
                                    <img src="<?php echo base_url(); ?>/assets/gambar/operator/<?php echo $operator['foto_operator'] ?>" alt="" height="200px">
                                <?php } else { ?>
                                    <div class="my-3">
